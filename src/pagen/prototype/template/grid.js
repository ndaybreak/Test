...
<% end %>
	...
	$scope.setAuth = function(){
        ...
        if(authList.role === "Super User"){
        	$scope.btn= '';
<% if xc.entity_name == 'OptPriceQualityBand' || xc.entity_name == 'OptSqMccExcp' || xc.entity_name == 'OptSqPricebookExcp' %>
		}else if(authList.role === "Sales Comp Admin"){
<% else %>
