...
ColVis.prototype = {
	...
	"_fnDrawCallback": function ()
	{
		...
		{
			if ( this.s.bShowAll ){
				if ( this.dom.buttons[i+1] !== null )
				{
					if ( aoColumns[i].bVisible )
					{
	                    $('input', this.dom.buttons[i+1])[0].checked = true;
					}
					else
					{
	                    $('input', this.dom.buttons[i+1])[0].checked = false;
					}
				}
			}
			else{
	...
	"_fnCollectionShow": function ()
	{
		...
		$(this.dom.button.children[0].children).attr("class","icon-remove");
		if ( !this.s.bCssPosition )
		{
	...
	"_fnCollectionHide": function (  )
	{
		...
		$(this.dom.button.children[0].children).attr("class","icon-chevron-down");
	},
